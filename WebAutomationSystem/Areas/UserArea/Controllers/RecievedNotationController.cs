...
namespace WebAutomationSystem.Areas.UserArea.Controllers
{
    ...
    public class RecievedNotationController : Controller
    {
        private readonly IUnitOfWork _context;
        private readonly INotationRepository _inotation;
        private readonly UserManager<ApplicationUsers> _userManager;

        public RecievedNotationController(IUnitOfWork context, INotationRepository inotation, UserManager<ApplicationUsers> userManager)
        {
            _context = context;
                                                  ...
                                                  string todate = "")
        {
            ...
            var model = _inotation.
                RecievedNotationList(_userManager.GetUserId(HttpContext.User),

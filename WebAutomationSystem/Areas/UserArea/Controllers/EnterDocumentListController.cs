...
namespace WebAutomationSystem.Areas.UserArea.Controllers
{
    ...
    public class EnterDocumentListController : Controller
    {
        private readonly IForignDocumentRepository _idoc;
        private readonly UserManager<ApplicationUsers> _userManager;

        public EnterDocumentListController(IForignDocumentRepository idoc, UserManager<ApplicationUsers> userManager)
        {
            _idoc = idoc;
                                               ...
                                               string todate = "")
        {
            ...
            //
            var model = _idoc.ForeignDocumentList(_userManager.GetUserId(HttpContext.User),

...
namespace WebAutomationSystem.Areas.UserArea.Controllers
{
    ...
    public class LetterListController : Controller
    {
                                                                    ...
                                                                    string todate = "")
        {
            ...
            var model = _iletter.
                MyLetter(_userManager.GetUserId(HttpContext.User),
                         ConvertDateTime.ConvertShamsiToMiladi(fromdate),
                         ConvertDateTime.ConvertShamsiToMiladi(todate),
                         classificationradio, replyradio, attachmentradio, readradio, searchTypeselected, immediatelytype, inputsearch);
            return View(model.OrderByDescending(l => l.LetterID));
        }
